...
<html lang="es">
<head>
	<title>Administración de cargos TECSUR</title>
	<?= $head ?>
</head>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6"><h1>Cargos</h1></div>
						<div class="col-sm-6">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-tools">
										<button type="button" class="btn btn-tool" title="Registrar cargo" id="btnRegistrarCargo"><i class="fas fa-plus"></i> Registrar cargo</button>
									</div>
								</div>
								<div class="card-body">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<ul><li id="x_cargo"></li></ul>
							</div>
						</div>
					</div>
					<div class="modal-footer">
						<input type="hidden" id="c_cargo" name="c_cargo">
		...
		<div class="modal fade" id="modalRegistrar" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title"><i class="fa fa-save"></i> Registrar cargo</h5>
					</div>
					<?php
		...
		<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title"><i class="fa fa-edit"></i> Editar cargo</h5>
					</div>
					<?php
					...
					<div class="modal-footer">
						<input type="hidden" id="ec_cargo" name="ec_cargo">
						<button type="button" class="btn btn-outline-danger btn-sm" data-dismiss="modal"><i class="fa fa-window-close"></i> Cancelar</button>
